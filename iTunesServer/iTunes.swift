...
// is a track currently being converted?
	optional var currentAirPlayDevices: NSArray {get set}
...
// run iTunes
	optional func quit()
// quit iTunes
	optional func add(x: NSArray, to: SBObject) -> iTunesTrack
...
// reposition to beginning of current track or go to previous track if already at start of current track
	optional func convert(x: NSArray) -> iTunesTrack
